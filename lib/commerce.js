 ...
 */
function saleAgreement({ dealer, branch, vehicle, buyer, price, deposit, balance, lender, ref }) {
  const today = new Date();
  const b = buyer || {};
  const v = vehicle || {};
  ...
  return {
    ...
    clauses: [
      ...
      'Both parties agree to complete the transfer of ownership on the NTSA system within seven days of the balance being settled. The seller will initiate the transfer and the buyer will approve it.',
